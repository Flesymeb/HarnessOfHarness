...
- 🎉 **2026-09** — [Mournlight](https://github.com/Flesymeb/mournlight), a Vampire Survivors–style roguelite, has reached 80+ autonomous loops. [View trajectory →](https://github.com/Flesymeb/mournlight)
- 🎉 **2026-09** — [Fusepoint](https://github.com/Flesymeb/fusepoint), a single-player narrative first-person shooter, has reached 70+ autonomous loops. [Watch demo →](https://flesymeb.github.io/HarnessOfHarness/#demo)
